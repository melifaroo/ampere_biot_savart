...
def main():   
    ...
    # NF = np.concatenate([np.concatenate([                                NFA, [[0]*(segB+segC)]*len(NFA) ], 1),
    # np.concatenate([[[0]*(segA)]*len(NFB)     ,     NFB, [[0]*(segC)]*len(NFB)      ], 1),
    # np.concatenate([[[0]*(segA+segB)]*len(NFC),     NFC                             ], 1)], 0)
    # print(NF)
    # exit()
    
    # presentation.plotetwas() 
    # exit()
    ...
    # demo_X()
    # demo_L()
        # geometry.sample_shell_3phInf()
        # geometry.sample_mono1()
    # demo_ABC(geometry.sample_shell_3phInf())
